...
const Terms = () => {
    ...
    const termsText = [
        ...
        <>
          ...
          <span> </span>
          <Link to={'/about'} className='terms-about-anchor'>
            here
          </Link>
          . The laws of Ireland are the applicable laws. Placing an order is of course completely voluntary. Of course, we do not use any automated profiling or decisions.
        </>,
